...
class OptDormioTestSuite extends AbstractTestSuite
{
    ...
    $this->hydration_set = $books->filterVar('price', '>', $this->_hydrate_id)->limit(5);
	$this->with_set = $books->with('author')->filterVar('title', '=', $this->_with_title)->limit(1);
    ...
    $this->related_set = $authors->filterVar('first_name', '=', $this->_related_name);
	}
